    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Cadastrar como dono</Text>
          <Text style={styles.sub}>Gerencie seus estacionamentos e receba reservas</Text>
        </View>

        <View style={styles.form}>
          <Input label="Nome / Razão social *" value={form.name} onChangeText={v => set('name', v)} placeholder="Estacionamento Central Ltda" />
          <Input label="E-mail *" value={form.email} onChangeText={v => set('email', v)} keyboardType="email-address" autoCapitalize="none" placeholder="contato@estacionamento.com" />
          <Input label="CPF / CNPJ" value={form.cpfCnpj} onChangeText={v => set('cpfCnpj', v)} keyboardType="numeric" placeholder="00.000.000/0001-00" />
          ...
          <Button title="Criar conta de dono" onPress={handleRegister} loading={loading} style={{ marginTop: 8 }} />
        </View>
